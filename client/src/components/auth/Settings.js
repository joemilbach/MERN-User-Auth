...
export default function Settings() {
  ...
  const submit = async (e) => {
    ...
    try {
      ...
      await Axios.post("http://localhost:8000/users/edit", editUser)
  ...
  return (
    <Container as="main" className="register" fluid>
      ...
      {userSettings.email && (
        <Form
          id="settingsForm"
          className="col-md-8 col-lg-6 mt-3"
          onSubmit={submit}
        >
          ...
          <Form.Group controlId="register-dispaly-name">
            ...
            <InputGroup>
              ...
              <Form.Control
                type="text"
                placeholder="Update what should we call you?"
                onChange={(e) => setDisplayName(e.target.value)}
              />
              <InputGroup.Append>
                <Button variant="outline-primary" onClick={displayNameReset}>
                  Reset
                </Button>
              </InputGroup.Append>
            </InputGroup>
