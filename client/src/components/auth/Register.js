    ...
    <Container as="main" className="register" fluid>
      ...
      <Form className="col-md-8 col-lg-6 mt-3" onSubmit={submit}>
        ...
        <Form.Group controlId="register-email">
          <Form.Label>Email address<em className="text-info">*</em></Form.Label>
          <Form.Control type="email" placeholder="name@domain.com" required onChange={e => setEmail(e.target.value)} />
        </Form.Group>

        <Form.Group controlId="register-dispaly-name">
          <Form.Label>Display name</Form.Label>
          <Form.Control type="text" placeholder="What should we call you?" onChange={e => setDisplayName(e.target.value)} />
        </Form.Group>

        <Form.Group controlId="register-password">
          <Form.Label className="m-0">Password<em className="text-info">*</em></Form.Label>
